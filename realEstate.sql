...
INSERT INTO `appoinment` VALUES (1,11,29,4,15,'2021-07-25','Cancelled'),(2,22,15,17,7,'2020-10-01','Completed'),(3,14,8,29,30,'2023-03-02','Completed'),(4,12,6,2,24,'2022-11-10','Scheduled'),(5,14,14,27,18,'2020-02-13','Scheduled'),(6,19,11,28,16,'2024-04-16','Scheduled'),(7,1,4,4,16,'2024-02-20','Cancelled'),(8,27,15,26,15,'2023-02-18','Scheduled'),(9,2,30,24,28,'2020-03-20','Completed'),(10,24,20,9,6,'2021-08-18','Completed'),(11,28,21,5,22,'2023-12-01','Completed'),(12,5,14,28,18,'2024-09-09','Completed'),(13,13,16,13,11,'2023-01-18','Completed'),(14,23,27,29,15,'2022-05-23','Cancelled'),(15,21,26,13,5,'2021-10-08','Cancelled'),(16,27,27,3,13,'2020-10-07','Scheduled'),(17,26,23,29,15,'2024-05-28','Scheduled'),(18,29,1,3,18,'2024-02-14','Completed'),(19,9,10,30,16,'2020-10-06','Completed'),(20,21,15,25,17,'2025-03-30','Scheduled'),(21,4,24,6,6,'2025-01-09','Cancelled'),(22,21,3,3,11,'2020-10-21','Cancelled'),(23,19,15,3,3,'2023-10-22','Scheduled'),(24,19,13,21,27,'2024-02-24','Completed'),(25,2,12,27,24,'2024-09-25','Cancelled'),(26,8,4,25,10,'2021-01-26','Cancelled'),(27,13,30,16,26,'2024-11-14','Cancelled'),(28,10,18,12,27,'2021-01-17','Completed'),(29,5,5,19,20,'2022-10-15','Scheduled'),(30,11,1,6,1,'2024-07-01','Cancelled');
...
INSERT INTO `transactions` VALUES (1,6,27,26,29,265083.94,'2022-11-10','Bank Transfer'),(2,15,12,8,24,269187.51,'2023-03-10','Bank Transfer'),(3,15,16,30,15,335645.24,'2022-07-27','Cash'),(4,29,24,12,18,492165.39,'2021-04-23','Bank Transfer'),(5,5,19,10,4,321309.64,'2023-03-12','Credit'),(6,28,29,29,17,208515.30,'2022-07-04','Bank Transfer'),(7,23,10,8,14,231914.78,'2023-05-24','Cash'),(8,23,9,22,18,326894.86,'2021-09-28','Bank Transfer'),(9,27,17,2,2,186283.14,'2021-05-11','Credit'),(10,10,17,8,13,133374.49,'2023-09-30','Bank Transfer'),(11,1,14,18,17,462831.35,'2021-05-11','Cash'),(12,22,23,19,8,363169.40,'2022-04-24','Cash'),(13,21,2,28,7,135388.60,'2022-11-06','Bank Transfer'),(14,16,22,30,15,344040.56,'2022-01-02','Cash'),(15,14,9,27,17,456410.46,'2022-07-10','Cash'),(16,18,7,1,20,378510.08,'2024-01-21','Cash'),(17,2,24,24,23,232084.62,'2023-02-07','Cash'),(18,3,25,19,13,465332.93,'2023-03-15','Credit'),(19,18,11,17,2,202285.86,'2024-10-19','Bank Transfer'),(20,23,24,17,4,444155.93,'2021-07-15','Credit'),(21,26,22,27,7,400018.08,'2020-10-13','Bank Transfer'),(22,12,3,29,13,210020.41,'2024-01-02','Bank Transfer'),(23,1,23,25,21,220727.14,'2024-04-13','Bank Transfer'),(24,8,16,3,8,420557.37,'2022-02-18','Credit'),(25,29,22,4,15,297781.55,'2023-01-04','Cash'),(26,23,18,11,23,160940.11,'2021-07-15','Bank Transfer'),(27,19,27,11,17,224296.21,'2024-11-21','Bank Transfer'),(28,3,6,6,6,185515.61,'2022-11-07','Credit'),(29,17,21,25,7,233339.39,'2022-10-21','Credit'),(30,25,16,29,13,317640.62,'2023-06-02','Bank Transfer');
...
/*!50003 DROP PROCEDURE IF EXISTS `agent_commission` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2025-04-03 11:44:41
